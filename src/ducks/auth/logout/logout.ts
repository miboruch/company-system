...
export const logout = createAsyncThunk<void, () => void, { dispatch: AppDispatch; state: AppState }>('logout/userLogout', async (callback: () => void, { rejectWithValue, dispatch, getState }) => {
  try {
