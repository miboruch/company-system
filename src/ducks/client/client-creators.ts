...
export const addNewClient = createAsyncThunk<void, AddClientInterface, baseStoreType>(
  'client/addNewClient',
...
export const deleteClient = createAsyncThunk<void, string, baseStoreType>(
  'client/deleteClient',
...
export const getSingleClient = createAsyncThunk<void, string, baseStoreType>(
...
export const editClient = createAsyncThunk<void, EditClientInterface, baseStoreType>(
  'client/editClient',
  async (values, { dispatch, getState }) => {
    const { token } = getState().auth.tokens;
...
export const editClientCoords = createAsyncThunk<void, EditClientCoorsInterface, baseStoreType>(
  'client/editClientCoords',
  async ({ clientId, lat, long }, { dispatch, getState }) => {
    const { token } = getState().auth.tokens;
